...
```json
{
    ...
    "workbench.colorCustomizations": {
        ...
        "statusBarItem.remoteForeground": "#e7e7e7",
        "commandCenter.border": "#e7e7e799",
        "inputOption.activeBackground": "#00aeffe0",
        "inputOption.activeForeground": "#f5f5f0",
        "editor.lineHighlightBackground": "#00cccc30",
        "editor.selectionForeground": "#000000aa",
        "editor.selectionBackground": "#0099ff86",
        "editor.inactiveSelectionBackground": "#168b16cc",
...
```json
{
	...
	"settings": {
		"editor.tabSize": 2,
    "workbench.colorCustomizations": {
        "panelTitleBadge.background":"#ff8c8c",
        "panelTitle.inactiveForeground":"#ff8c8c",
        ...
        "inputOption.activeBackground": "#00ff91e0",
        "inputOption.activeForeground": "#002d22",
        "editor.lineHighlightBackground": "#00cccc30",
        "editor.selectionForeground": "#000000aa",
        "editor.selectionBackground": "#0099ff86",
        "editor.inactiveSelectionBackground": "#168b16cc",
